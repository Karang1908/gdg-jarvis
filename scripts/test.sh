...
#   scripts/test.sh
#
# Three suites. The first two always run; the MCP one needs a Python venv with the SDK and
...
printf '\n\033[1m1/3  wire encoding\033[0m\n'
node core/test/wire.test.js || FAILED=1

printf '\n\033[1m2/3  API, end to end\033[0m\n'
node core/test/api.test.js || FAILED=1

printf '\n\033[1m3/3  MCP tools\033[0m\n'
PYTHON=""
